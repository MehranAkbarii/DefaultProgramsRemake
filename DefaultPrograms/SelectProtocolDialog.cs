    ...
    public partial class SelectProtocolDialog : Form {
        ...
        private void okButton_Click(object sender, EventArgs e) {
            if (progslistView.SelectedItems.Count > 0) {
                ...
                } else if (appnames[progslistView.SelectedItems[0].Text].Equals("Program")) {

                    AppAssociation.changeProtocolAssociation(progslistView.SelectedItems[0].Text.ToString(), protocol , "Program");
                } else
